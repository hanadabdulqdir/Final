...
public class Tab2 extends BaseFragment implements IAnimeMvpView {

    private AnimePresenterImpl<Tab2> classicMusicClassicMusicPresenter;
                ...
                .subscribe(new Consumer<Boolean>() {
                    ...
                    public void accept(Boolean isConnectedToInternet) throws Exception {
                        if (isConnectedToInternet) {
                            ...
                            recyclerView.setAdapter(new AnimeRealmAdapter(getActivity(), MainActivity.getRealmDatabase(), R.layout.row_anime));
